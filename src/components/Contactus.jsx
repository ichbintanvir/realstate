...
const Contactus = () => {
    ...
    return (
        <div className="h-[545px] w-full bg-contactBG bg-cover bg-center py-[50px]">
            ...
            <div className="w-[300px] md:w-[776px] h-[465px] mx-auto bg-customBlack place-content-center py-[16px]">
                ...
                <form onSubmit={ok} className="px-[16px] md:px-[176px]">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-[20px] font-outfit font-[400] text-[#D6D6D6]">
                        <span className="flex flex-col col-span-2 md:col-span-1">
                            ...
                            <input className="bg-transparent border border-white px-[8px] py-[10px] text-[12px]" type="text" placeholder="Ex. Adnan" required />
                        </span>
                        <span className="flex flex-col col-span-2 md:col-span-1">
                            <label htmlFor="" className="text-[14px]">Last Name*</label>
                            <input className="bg-transparent border border-white px-[8px] py-[10px] text-[12px]" type="text" placeholder="Ex. Ralf" required />
                        </span>
                        <span className="flex flex-col col-span-2 mt-[20px]">
                            <label htmlFor="" className="text-[14px]">Email*</label>
                            <input className="bg-transparent border border-white px-[8px] py-[10px] text-[12px]" type="email" placeholder="example@gmail.com" required />
                        </span>
                    </div>
